...
CREATE TABLE seguindo(
    ...
    artista_id int not null,
    foreign key(artista_id) references artista(artista_id),
    primary key (seguidor_id, user_id, artista_id)
);
INSERT INTO `plano` (`plano_name`, `valor_plano`)
VALUES
    ('gratuito', 0),
    ('familiar', 7.99),
    ('universitário', 5.99),
...
('Tyler Isle'),
('Fog');
insert into `album` (`album_name`, `ano_lancamento`, `artista_id`)
values
('Envious', 1990, 1),
('Exuberant', 1993, 1),
('Hallowed Steam', 1995, 2),
('Incandescent', 1998, 3),
('Temporary Culture', 2003, 4),
('Library of liberty', 2007, 4),
('Chained Down', 2007, 5),
('Cabinet of fools' , 2012, 5),
('No guarantees' , 2015, 5),
('Apparatus', 2015, 6);
insert into `usuario` (`user_name`, `user_age`, `plano_id`, `data_assinatura`)
values
...
(10, 2),
(10, 6);
insert into `cancao` (`cancao_name`, `duracao_segundos`, `album_id`, `artista_id`)
values
('Soul For Us', 200, 1, 1),
...
('I Heard I Whant To Bo Alone', 120, 9, 5),
...
insert into `historico` (`user_id`, `cancao_id`, `data_reproducao` )
values
